...
>
> **Most of this skill's style menu is banned here.** Of the styles it offers,
> `gradient`, `glassmorphism`, `3D`, `neon` and `retro` are all on the
...
> Vary composition, crop and copy. The direction itself is settled.

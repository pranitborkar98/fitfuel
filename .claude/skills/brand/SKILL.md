...
>
> **Voice is already specified.** The rules, non-negotiable:
>
> - No em dashes anywhere. Use commas, colons, periods.
> - Sentence case body, UPPERCASE display.
> - Concrete and specific over adjectives. Numbers over claims.
> - English only, Pune-first.
> - Never advertise a capability the product does not ship.
> - No decorative micro-labels, spec codes or eyebrow chips. The owner reads
>   these as AI slop on sight.
>
> Use this skill for **messaging frameworks and asset management** — audience
> definition, message hierarchy, consistency auditing. Not for tone discovery
> and not for visual identity.

...
const PROGRAM: PlannedDay[] = [
  ...
  {
    // ⚠️ TEMPORARY — flipped from REST to a workout day ONLY to verify the burn
    // path today (Wed). After you confirm the dashboard ring shows Burned = 200,
    // re-run the ORIGINAL seed-exercise-schedule-weight-loss.ts to restore rest.
    dayOfWeek: "wednesday",
    focusArea: "Full Body (verification)",
    estimatedCalories: 200,
    isRestDay: false,
    exercises: [
      { name: "Bodyweight Squat", sets: 3, reps: 15, restSecs: 45 },
      { name: "Pushups", sets: 3, reps: 12, restSecs: 45 },
      { name: "Plank", sets: 3, durationSecs: 40, restSecs: 30 },
    ],
  },
  {
    dayOfWeek: "thursday",

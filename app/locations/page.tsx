      ...
      <section style={{ paddingTop: 140, paddingBottom: 80 }}>
        <div style={WRAP}>
          <motion.div initial="hidden" animate="visible" variants={stagger}>
            ...
            <FadeItem>
              <p style={{ fontSize: 17, color: "#9ca3af", lineHeight: 1.8, maxWidth: 520, marginBottom: 0 }}>
                ...
                return (
                  <FadeItem key={s.label}>
                    <div style={{
                      ...
                      <div>
                        <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 32, fontWeight: 900, color: "#84cc16", lineHeight: 1 }}>
                          {s.value}
                        </div>
                  ...
                  <FadeItem key={zone.name}>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div style={{ fontSize: 11, color: "#6b7280", marginTop: 1 }}>{zone.pincode}</div>
                      </div>
                    </div>
                  </FadeItem>
                ))}
                ...
                <FadeItem>
                  <div style={{
                    ...
                    <div style={{ padding: "18px 24px 14px", borderBottom: "1px solid #1a1a1a" }}>
                      ...
                      <div style={{ fontSize: 11, color: "#6b7280", marginTop: 2 }}>All deliveries dispatched from here daily at 7am</div>
                    </div>
                    <iframe
            ...
            <FadeItem>
              <div style={{
                ...
                <div style={{ position: "relative", zIndex: 1 }}>
                  ...
                  <p style={{ fontSize: 15, color: "#9ca3af", maxWidth: 400, lineHeight: 1.7 }}>

      ...
      <section style={{ paddingTop: 140, paddingBottom: 80 }}>
        <div style={WRAP}>
          <motion.div initial="hidden" animate="visible" variants={stagger}>
            ...
            <FadeItem>
              <p style={{ fontSize: 17, color: "#9ca3af", lineHeight: 1.8, maxWidth: 520 }}>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: 12, color: "#6b7280" }}>Opens WhatsApp with your message pre-filled</div>
                    </div>
                  </div>
                  ...
                  <div style={{ padding: "28px 32px 32px" }}>
                    ...
                    <div style={{ marginBottom: 24 }}>
                      <label style={{ display: "block", fontSize: 12, fontWeight: 600, color: "#9ca3af", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 8 }}>
                        Your name (optional)
                      </label>
                      <input
                        type="text"
                    ...
                    {/* Reason selector */}
                    <div style={{ marginBottom: 24 }}>
                      <label style={{ display: "block", fontSize: 12, fontWeight: 600, color: "#9ca3af", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 12 }}>
                        What&apos;s it about?
                      </label>
                        ...
                        {QUICK_REASONS.map((r, i) => (
                          <button
                            ...
                            style={{
                              ...
                              color: selected === i ? "#f9fafb" : "#9ca3af",
                ...
                {CONTACT_DETAILS.map(item => {
                  ...
                  const card = (
                    ...
                    >
                      ...
                      <div style={{ flex: 1 }}>
                        <div style={{ fontSize: 11, fontWeight: 600, color: "#6b7280", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 4 }}>
                          {item.label}
                        </div>

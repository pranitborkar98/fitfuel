            ...
            {prices.map((p: any) => {
              ...
              return (
                <div key={p.id} style={{ background: T.card, border: `1px solid ${c.popular ? "rgba(132,204,22,0.5)" : T.cardBorder}`, borderRadius: 16, padding: 28, position: "relative", boxShadow: c.popular ? "0 0 30px rgba(132,204,22,0.08)" : "none" }}>
                  {c.popular && <span style={{ position: "absolute", top: -11, left: 28, background: T.accent, color: "#0a0a0a", fontSize: 11, fontWeight: 800, padding: "4px 12px", borderRadius: 999, letterSpacing: "0.05em" }}>MOST POPULAR</span>}

...
export default function Home(props: HomeProps) {
  ...
  const glyphs = useMemo(
    () => ({
      plans: <Marks count={counts.plans ?? 126} per={1} cols={14} accent="#a3e635" className={c("v2-wipe")} />,
      ...
      foods: <Marks count={counts.foods ?? 154} per={1} cols={16} accent="#84cc16" className={c("v2-wipe")} />,
      prices: <Marks count={counts.prices ?? 3614} per={32} cols={14} accent="#c6c6c0" className={c("v2-wipe")} />,
    }),
    [counts],
  );
  ...
  const ticker = [
    { n: count(counts.plans ?? 126), l: "plans", accent: "#a3e635", glyph: glyphs.plans, scale: "one mark each" },
    ...
    { n: count(counts.foods ?? 154), l: "foods", accent: "#84cc16", glyph: glyphs.foods, scale: "one mark each" },
    { n: count(counts.prices ?? 3614), l: "published prices", accent: "#f7f7f5", glyph: glyphs.prices, scale: "one mark = 32" },
  ];

  const label12 = { fontFamily: MONO, fontSize: 12, letterSpacing: "0.2em", textTransform: "uppercase" as const, color: "#85857e" };
  const h2 = (max: string) => ({
  ...
  return (
    <div
      ...
      style={{ position: "relative", background: "#070707", color: "#f7f7f5", minHeight: "100vh", overflowX: "clip", fontFamily: SANS }}
    >
      <div
        aria-hidden="true"
        style={{
        ...
        <div className={c("v2-hero-grid")} style={{ position: "relative", display: "grid", gridTemplateColumns: "minmax(0,1.05fr) minmax(0,0.95fr)", alignItems: "stretch", minHeight: "calc(100svh - 66px)" }}>
          <div style={{ display: "flex", flexDirection: "column", justifyContent: "flex-end", padding: "clamp(44px,8vh,96px) clamp(24px,3.4vw,56px) clamp(36px,6vh,64px) max(clamp(18px,4vw,40px),calc((100vw - 1240px) / 2))" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: "clamp(20px,3vh,32px)" }}>
              ...
              <span style={{ fontFamily: MONO, fontSize: 12, letterSpacing: "0.22em", textTransform: "uppercase", color: "#85857e" }}>Kharadi kitchen · cooking now</span>
              <span aria-hidden="true" style={{ flex: 1, height: 1, background: "#232320", maxWidth: 120 }} />
            </div>

            <h1 id="v2-h1" style={{ fontFamily: COND, fontWeight: 900, fontSize: "clamp(3rem,6.4vw,6.8rem)", lineHeight: 0.8, letterSpacing: "-0.035em", textTransform: "uppercase", color: "#f7f7f5", margin: 0 }}>
              ...
              <span className={c("v2-line")} style={{ color: "#84cc16" }}><span style={{ animationDelay: ".27s" }}>again.</span></span>
            </h1>

            <p className={c("v2-in")} style={{ fontFamily: SANS, fontSize: "clamp(16px,1.4vw,18.5px)", lineHeight: 1.62, color: "#c6c6c0", margin: "clamp(22px,3vh,32px) 0 0", maxWidth: "44ch", animationDelay: ".42s" }}>
              Four chef-cooked meals, weighed to your macros on a scale, at your door by{" "}
              <b style={{ color: "#f7f7f5", fontWeight: 600 }}>08:00</b>, six mornings a week. No cooking, no counting, no 7pm Swiggy decision.
            </p>
            ...
            <div className={c("v2-in")} style={{ display: "flex", flexDirection: "column", alignItems: "flex-start", gap: 18, marginTop: "clamp(24px,3.6vh,36px)", animationDelay: ".54s" }}>
              <Link href="/plans?trial=true" className={c("v2-btn")} style={{ display: "inline-flex", alignItems: "center", background: "#84cc16", color: "#070707", fontFamily: COND, fontWeight: 900, fontSize: 17, letterSpacing: "0.06em", textTransform: "uppercase", padding: "17px 30px", minHeight: 52, border: "1px solid #84cc16" }}>
                <span>Start with one day, ₹{decompose(400, 1).total}</span>
              </Link>
              <a href="#v2-plates" className={c("v2-underline")} style={{ display: "inline-block", fontFamily: MONO, fontSize: 12, letterSpacing: "0.14em", textTransform: "uppercase", color: "#84cc16", paddingBottom: 3 }}>See tomorrow&rsquo;s four meals</a>
            </div>

            <div className={c("v2-in")} style={{ display: "flex", alignItems: "baseline", gap: 14, flexWrap: "wrap", marginTop: "clamp(26px,4vh,40px)", paddingTop: 20, borderTop: "1px solid #232320", animationDelay: ".66s" }}>
              <span style={{ fontFamily: MONO, fontSize: 11, letterSpacing: "0.2em", textTransform: "uppercase", color: "#85857e" }}>Cut-off for tomorrow</span>
              <span suppressHydrationWarning style={{ fontFamily: MONO, fontWeight: 700, fontSize: "clamp(18px,2.2vw,24px)", color: "#f7f7f5", fontVariantNumeric: "tabular-nums", letterSpacing: "0.02em" }}>{countdown}</span>
              <span style={{ fontFamily: SANS, fontSize: 13.5, color: "#9a9a94" }}>order by 9pm, eat at 8am</span>
            </div>
          </div>

          <div style={{ display: "flex", flexDirection: "column", borderLeft: "1px solid #232320", minHeight: "52vh" }}>
            <figure style={{ position: "relative", margin: 0, flex: 1, minHeight: "38vh", overflow: "hidden", background: "#050504" }}>
              ...
              <figcaption style={{ position: "absolute", left: 0, top: 0, display: "flex", alignItems: "center", gap: 9, background: "#070707", borderRight: "1px solid #232320", borderBottom: "1px solid #232320", padding: "10px 14px", fontFamily: MONO, fontSize: 10.5, letterSpacing: "0.18em", textTransform: "uppercase", color: "#85857e" }}>
                <span aria-hidden="true" style={{ width: 6, height: 6, background: "#84cc16" }} />Weighed at 06:31 today
              </figcaption>
            </figure>

            <div className={c("v2-hero-deck")} style={{ position: "relative", display: "grid", gridTemplateColumns: "minmax(0,1fr) auto", gap: "clamp(16px,2.4vw,32px)", alignItems: "center", background: "#070707", borderTop: "1px solid #232320", padding: "clamp(18px,2.4vw,30px)" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "clamp(14px,1.8vw,22px)" }}>
                <div style={{ position: "relative", width: "clamp(88px,8.4vw,124px)", aspectRatio: "1", display: "grid", placeItems: "center" }}>
                  <Ring kcal={days[0]!.kcal} protein={81} carbs={218} fat={41} sw={9} pal={["#f7f7f5", "#9a9a94", "#3a3a36"]} />
                  <b style={{ position: "relative", fontFamily: COND, fontWeight: 900, fontSize: "clamp(22px,2.2vw,31px)", lineHeight: 1, letterSpacing: "-0.03em", color: "#f7f7f5", fontVariantNumeric: "tabular-nums" }}>
                    {Math.round(days[0]!.kcal * (0.06 + 0.94 * rev)).toLocaleString("en-IN")}
                  </b>
                </div>
                <div style={{ display: "flex", flexDirection: "column", gap: 7 }}>
                  <span style={{ fontFamily: MONO, fontSize: 11, letterSpacing: "0.2em", textTransform: "uppercase", color: "#85857e" }}>Tomorrow</span>
                  <span style={{ fontFamily: MONO, fontSize: 11.5, letterSpacing: "0.1em", textTransform: "uppercase", color: "#f7f7f5" }}>kcal · {Math.round(days[0]!.protein)}g protein</span>
                  <span style={{ fontFamily: MONO, fontSize: 11, letterSpacing: "0.1em", color: "#85857e" }}>4 meals, weighed</span>
                </div>
              </div>
                ...
                <div className={c("v2-tilt")} style={{ width: "100%", height: "100%", display: "grid", placeItems: "center" }}>
                  <div className={c("v2-loop", "aFloat8")}>
                    <div className={c("v2-box")} style={{ position: "relative", width: 150, height: 44 }}>
                      ...
                      <div className={c("v2-box-face")} style={{ width: 150, height: 44, transform: "rotateY(180deg) translateZ(56px)", background: "#0a0a09" }} />
                      <div className={c("v2-box-face")} style={{ width: 112, height: 44, left: 19, transform: "rotateY(90deg) translateZ(75px)", background: "#121210" }} />
                      <div className={c("v2-box-face")} style={{ width: 112, height: 44, left: 19, transform: "rotateY(-90deg) translateZ(75px)", background: "#0a0a09" }} />
                      <div className={c("v2-box-face")} style={{ width: 150, height: 112, top: -34, transform: "rotateX(90deg) translateZ(22px)", background: "#141412", display: "grid", gridTemplateColumns: "1fr 1fr", gridTemplateRows: "1fr 1fr", gap: 1, padding: 6 }}>
                        <span style={{ background: "#84cc16" }} />
                        <span style={{ background: "#3f5a10" }} />
                        <span style={{ background: "#26320c" }} />
                        <span style={{ background: "#1b1f10" }} />
                      </div>
                      <div className={c("v2-box-face")} style={{ width: 150, height: 112, top: -34, transform: "rotateX(-90deg) translateZ(22px)", background: "#080807" }} />
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div className={c("v2-readout")} style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", background: "#050504", borderBottom: "1px solid #232320", padding: "0 max(clamp(18px,4vw,40px),calc((100vw - 1240px) / 2))" }}>
        <div className={c("v2-cell")} style={{ padding: "clamp(18px,2.4vw,28px) clamp(14px,2.2vw,26px)", borderLeft: "1px solid #232320", display: "flex", flexDirection: "column", gap: 12 }}>
          <div style={{ fontFamily: COND, fontWeight: 900, fontSize: "clamp(1.5rem,3vw,2.4rem)", lineHeight: 0.82, letterSpacing: "-0.04em", color: "#f7f7f5", fontVariantNumeric: "tabular-nums" }}>08:00</div>
          <div style={{ fontFamily: SANS, fontSize: 13.5, lineHeight: 1.55, color: "#9a9a94" }}>at your door, six mornings a week</div>
          <div style={{ marginTop: "auto", display: "flex", flexDirection: "column", gap: 7 }}>
            <div aria-hidden="true" style={{ position: "relative", height: 18, borderLeft: "1px solid #33332f", borderRight: "1px solid #33332f" }}>
              <span style={{ position: "absolute", left: 0, right: 0, top: 8, height: 1, background: "#232320" }} />
              <span className={c("aGrow9")} style={{ position: "absolute", left: "16.7%", width: "16.6%", top: 3, height: 12, background: "#84cc16", transformOrigin: "left", animationDelay: ".2s" }} />
              <span className={c("v2-loop", "aTravel6")} aria-hidden="true" style={{ position: "absolute", top: 1, left: "16.7%", width: "16.6%", height: 16, willChange: "transform" }}>
                <span style={{ display: "block", width: 6, height: 16, background: "#f7f7f5" }} />
              </span>
            </div>
            <div style={{ display: "flex", justifyContent: "space-between", fontFamily: MONO, fontSize: 10, letterSpacing: "0.12em", textTransform: "uppercase", color: "#85857e" }}>
              <span>00:00</span><span style={{ color: "#f7f7f5" }}>04:00 cook</span><span style={{ color: "#f7f7f5" }}>08:00 door</span><span>24:00</span>
            </div>
          </div>
        </div>

        <div className={c("v2-cell")} style={{ padding: "clamp(18px,2.4vw,28px) clamp(14px,2.2vw,26px)", borderLeft: "1px solid #232320", display: "flex", flexDirection: "column", gap: 12 }}>
          <div style={{ fontFamily: COND, fontWeight: 900, fontSize: "clamp(1.5rem,3vw,2.4rem)", lineHeight: 0.82, letterSpacing: "-0.04em", color: "#f7f7f5", fontVariantNumeric: "tabular-nums" }}>₹{decompose(400, 1).total}</div>
          <div style={{ fontFamily: SANS, fontSize: 13.5, lineHeight: 1.55, color: "#9a9a94" }}>one full day, four meals, all in, nothing to cancel</div>
          <div style={{ marginTop: "auto", display: "flex", flexDirection: "column", gap: 7 }}>
            <div aria-hidden="true" style={{ display: "flex", height: 12, gap: 1 }}>
              {[["71.4%", "#f7f7f5", ".1s"], ["11.9%", "#a3e635", ".22s"], ["11.9%", "#5f5f59", ".34s"], ["4.8%", "#3a3a36", ".46s"]].map(([wd, bg, d], i) => (
                <span key={i} className={c("aGrow7")} style={{ width: wd, background: bg, transformOrigin: "left", animationDelay: d }} />
              ))}
            </div>
            <div style={{ display: "flex", justifyContent: "space-between", gap: 8, fontFamily: MONO, fontSize: 10, letterSpacing: "0.12em", textTransform: "uppercase", color: "#85857e" }}>
        ...
        <div className={c("v2-cell")} style={{ padding: "clamp(18px,2.4vw,28px) clamp(14px,2.2vw,26px)", borderLeft: "1px solid #232320", display: "flex", flexDirection: "column", gap: 12 }}>
          <div style={{ fontFamily: COND, fontWeight: 900, fontSize: "clamp(1.5rem,3vw,2.4rem)", lineHeight: 0.82, letterSpacing: "-0.04em", color: "#f7f7f5", fontVariantNumeric: "tabular-nums" }}>15</div>
          <div style={{ fontFamily: SANS, fontSize: 13.5, lineHeight: 1.55, color: "#9a9a94" }}>areas of east Pune, from one kitchen in Kharadi</div>
          <div style={{ marginTop: "auto", display: "flex", flexDirection: "column", gap: 7 }}>
            <div aria-hidden="true" style={{ display: "flex", alignItems: "flex-end", gap: 3, height: 18 }}>
              <span style={{ flex: 1, height: 18, background: "#f7f7f5" }} />
              {AREA_TICKS.map((h, i) => (
                <span key={i} className={c("aMark5")} style={{ flex: 1, height: h, background: "#3a3a36", transformOrigin: "bottom", animationDelay: `${240 + i * 45}ms` }} />
              ))}
            </div>
            <div style={{ display: "flex", justifyContent: "space-between", fontFamily: MONO, fontSize: 10, letterSpacing: "0.12em", textTransform: "uppercase", color: "#85857e" }}>
              <span style={{ color: "#f7f7f5" }}>Kharadi, the kitchen</span><span>14 delivered</span>
            </div>
          </div>
        </div>

        <div className={c("v2-cell")} style={{ padding: "clamp(18px,2.4vw,28px) clamp(14px,2.2vw,26px)", borderLeft: "1px solid #232320", display: "flex", flexDirection: "column", gap: 12 }}>
          <div style={{ fontFamily: COND, fontWeight: 900, fontSize: "clamp(1.5rem,3vw,2.4rem)", lineHeight: 0.82, letterSpacing: "-0.04em", color: "#f7f7f5", fontVariantNumeric: "tabular-nums" }}>FSSAI</div>
          <div style={{ fontFamily: SANS, fontSize: 13.5, lineHeight: 1.55, color: "#9a9a94" }}>our own licence, not a rented shift</div>
          <div style={{ marginTop: "auto", display: "flex", flexDirection: "column", gap: 7 }}>
            <div aria-hidden="true" style={{ display: "flex", gap: 1, background: "#232320", border: "1px solid #232320" }}>
              {licence.split("").map((d, i) => (
                <span key={i} style={{ flex: 1, textAlign: "center", padding: "3px 0", background: "#070707", fontFamily: MONO, fontSize: 10.5, color: "#f7f7f5", overflow: "hidden" }}>
            ...
            <div style={{ fontFamily: MONO, fontSize: 10, letterSpacing: "0.12em", textTransform: "uppercase", color: "#85857e" }}>verified against the FSSAI register</div>
          </div>
        </div>
      </div>

      {/* ══ THE COUNTS ══ */}
      <div ref={stripRef} className={c("v2-strip")} style={{ display: "grid", gridTemplateColumns: "repeat(6,minmax(0,1fr))", background: "#050504", borderBottom: "1px solid #232320" }}>
        {ticker.map((t) => (
          <div key={t.l} className={c("v2-cell")} style={{ display: "flex", flexDirection: "column", borderLeft: "1px solid #232320" }}>
            <div style={{ position: "relative", aspectRatio: "16/10", background: "#070707", borderBottom: "1px solid #232320", padding: "clamp(12px,1.6vw,20px)" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8, padding: "clamp(16px,2vw,24px) clamp(12px,1.8vw,20px)" }}>
              <b style={{ fontFamily: COND, fontWeight: 900, fontSize: "clamp(1.7rem,3.4vw,2.9rem)", lineHeight: 0.84, letterSpacing: "-0.035em", color: t.accent, fontVariantNumeric: "tabular-nums" }}>{t.n}</b>
              <span style={{ fontFamily: MONO, fontSize: 11, letterSpacing: "0.18em", textTransform: "uppercase", color: "#85857e" }}>{t.l}</span>
              <span style={{ fontFamily: MONO, fontSize: 10.5, letterSpacing: "0.14em", textTransform: "uppercase", color: "#85857e" }}>{t.scale}</span>
            </div>
          </div>
        ))}
      </div>
      ...
      <section id="v2-plates" aria-labelledby="v2-plates-h" style={{ padding: "clamp(56px,7vw,96px) 0" }}>
        <div style={WRAP}>
          ...
          <div className={c("v2-split")} style={{ display: "grid", gridTemplateColumns: "minmax(0,1.1fr) minmax(0,1fr)", gap: "clamp(24px,4vw,56px)", alignItems: "end" }}>
            ...
            <div className={c("v2-rise")}>
              ...
              <div style={{ display: "flex", gap: "clamp(18px,3vw,36px)", flexWrap: "wrap", marginTop: 24 }}>
                {([[Math.round(days[0]!.kcal).toLocaleString("en-IN"), "kcal across the day", "#84cc16"], [Math.round(days[0]!.protein) + "g", "protein, weighed", "#f7f7f5"], ["04:00", "cook starts", "#f7f7f5"]] as [string, string, string][]).map(([n, l, col]) => (
                  <div key={l}>
                    <b style={{ display: "block", fontFamily: COND, fontWeight: 900, fontSize: "clamp(26px,3.6vw,40px)", lineHeight: 0.9, letterSpacing: "-0.03em", color: col, fontVariantNumeric: "tabular-nums" }}>{n}</b>
                    <span style={{ fontFamily: MONO, fontSize: 10.5, letterSpacing: "0.16em", textTransform: "uppercase", color: "#85857e" }}>{l}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className={c("v2-plates")} style={{ display: "grid", gridTemplateColumns: "1.4fr 1fr 1fr 1fr", gap: 1, background: "#232320", border: "1px solid #232320", marginTop: "clamp(30px,4vw,52px)" }}>
            {days[0]!.dishes.map((d, i) => {
              ...
              const bars = [
                ...
                { name: "Carbs", v: Math.round(d.carbs) + "g", pct: Math.round((d.carbs / t) * 100), color: "#9a9a94", delay: 290 + i * 90 },
                { name: "Fat", v: Math.round(d.fat) + "g", pct: Math.round((d.fat / t) * 100), color: "#5f5f59", delay: 380 + i * 90 },
              ];
              return (
                <article key={d.slot} className={c("v2-plate", "v2-in")} style={{ position: "relative", background: "#070707", display: "flex", flexDirection: "column", border: "1px solid transparent", animationDelay: `${60 + i * 90}ms` }}>
                  ...
                  <div style={{ position: "relative", aspectRatio: "4/3", overflow: "hidden", background: "#0a0a09" }}>
                    <ImageSlot placeholder={d.name} />
                    <span aria-hidden="true" className={c("v2-scan")} style={{ top: "-34%" }} />
                    <span style={{ position: "absolute", top: 0, left: 0, pointerEvents: "none", fontFamily: MONO, fontSize: 11, letterSpacing: "0.2em", textTransform: "uppercase", color: "#070707", background: accent, padding: "7px 11px", zIndex: 2 }}>{d.slot}</span>
                    <b aria-hidden="true" className={c("v2-idx")} style={{ position: "absolute", right: 10, bottom: 2, pointerEvents: "none", fontFamily: COND, fontWeight: 900, fontSize: "clamp(3.4rem,6vw,5.4rem)", lineHeight: 0.8, letterSpacing: "-0.04em", color: accent, opacity: 0.28, zIndex: 2 }}>{String(i + 1).padStart(2, "0")}</b>
                  </div>
                  <div style={{ padding: "clamp(18px,2vw,24px)", display: "flex", flexDirection: "column", flex: 1 }}>
                    <span style={{ display: "block", fontFamily: MONO, fontSize: 10.5, letterSpacing: "0.18em", textTransform: "uppercase", color: accent, marginBottom: 9 }}>{d.cuisine}</span>
                    <h3 style={{ fontFamily: COND, fontWeight: 800, fontSize: "clamp(1.1rem,1.7vw,1.35rem)", lineHeight: 1, letterSpacing: "-0.01em", textTransform: "uppercase", color: "#f7f7f5", margin: 0 }}>{d.name}</h3>
                    <p style={{ fontFamily: SANS, fontSize: 13.5, lineHeight: 1.55, color: "#9a9a94", margin: "10px 0 0" }}>{d.blurb}</p>
                    <div style={{ marginTop: "auto", paddingTop: 20, display: "flex", flexDirection: "column", gap: 9 }}>
                      {bars.map((b) => (
                        <div key={b.name}>
                          <div style={{ display: "flex", justifyContent: "space-between", fontFamily: MONO, fontSize: 10.5, letterSpacing: "0.12em", textTransform: "uppercase", color: "#85857e", marginBottom: 5 }}>
                            <span>{b.name}</span><span style={{ color: "#f7f7f5" }}>{b.v}</span>
                          </div>
                          <div style={{ height: 4, background: "#1c1c1a" }}>
                            <span className={c("v2-bar")} style={{ display: "block", height: "100%", width: `${b.pct}%`, background: b.color, animationDelay: `${b.delay}ms` }} />
                          </div>
                        </div>
                      ))}
                      <div style={{ display: "flex", alignItems: "baseline", justifyContent: "space-between", gap: 10, paddingTop: 13, borderTop: "1px solid #232320" }}>
                        <span style={{ display: "flex", alignItems: "baseline", gap: 6 }}>
                          <b style={{ fontFamily: COND, fontWeight: 900, fontSize: "clamp(1.5rem,2.4vw,2rem)", lineHeight: 0.9, letterSpacing: "-0.03em", color: accent, fontVariantNumeric: "tabular-nums" }}>{d.kcal}</b>
                          <span style={{ fontFamily: MONO, fontSize: 10.5, letterSpacing: "0.14em", textTransform: "uppercase", color: "#85857e" }}>kcal</span>
                        </span>
                        <span style={{ fontFamily: MONO, fontSize: 11, letterSpacing: "0.1em", textTransform: "uppercase", color: "#85857e" }}>{Math.round(d.fibre)}g fibre</span>
                      </div>
                    </div>
                  </div>
                </article>
      ...
      {/* ══ THE WEEK ══ */}
      <section id="v2-week" aria-labelledby="v2-week-h" style={{ padding: "clamp(72px,10vw,150px) 0", background: "#050504", borderTop: "1px solid #232320" }}>
        <div style={WRAP}>
          <div aria-hidden="true" style={RULE} />
          <div className={c("v2-split")} style={{ display: "grid", gridTemplateColumns: "minmax(0,1.1fr) minmax(0,1fr)", gap: "clamp(24px,4vw,56px)", alignItems: "end" }}>
          ...
          <figure style={{ margin: "clamp(30px,4vw,52px) 0 0", border: "1px solid #232320", background: "#070707" }}>
            <figcaption style={{ display: "flex", alignItems: "baseline", justifyContent: "space-between", gap: 16, flexWrap: "wrap", padding: "clamp(14px,1.8vw,20px) clamp(14px,2vw,22px)", borderBottom: "1px solid #232320", fontFamily: MONO, fontSize: 10.5, letterSpacing: "0.16em", textTransform: "uppercase", color: "#85857e" }}>
              <span style={{ color: "#f7f7f5" }}>Thirty-day rotation, kcal per day</span>
              <span>low {Math.min(...band).toLocaleString("en-IN")} · average <b style={{ color: "#84cc16", fontWeight: 700 }}>{Math.round(band.reduce((a, b) => a + b, 0) / band.length).toLocaleString("en-IN")}</b> · peak {Math.max(...band).toLocaleString("en-IN")}</span>
            </figcaption>
            <div style={{ padding: "clamp(10px,1.4vw,16px) clamp(6px,1vw,12px) 0" }}>
              <div style={{ position: "relative", lineHeight: 0 }}>
                {bandChart}
                <span aria-hidden="true" style={{ position: "absolute", top: "6.9%", bottom: "13%", width: 1, background: "#84cc16", left: bandActiveLeft(day), transition: "left .3s cubic-bezier(.16,1,.3,1)" }} />
              </div>
            </div>
          </figure>

          <div style={{ display: "flex", flexWrap: "wrap", gap: "clamp(12px,2vw,26px)", marginTop: "clamp(18px,2.4vw,28px)", fontFamily: MONO, fontSize: 10.5, letterSpacing: "0.16em", textTransform: "uppercase", color: "#85857e" }}>
            {(["#d9f99d", "#bef264", "#a3e635", "#84cc16"] as const).map((col, i) => (
            ...
            <span style={{ marginLeft: "auto", color: "#5f5f59" }}>Columns scaled from {floorK.toLocaleString("en-IN")} kcal, not from zero</span>
          </div>
              ...
              return (
                <button key={x.d} type="button" onClick={() => setDay(x.d)} aria-pressed={on} style={{ display: "flex", flexDirection: "column", justifyContent: "flex-end", height: "100%", gap: 8, background: "transparent", border: 0, padding: 0, cursor: "pointer", textAlign: "left" }}>
                  <span style={{ flex: "1 1 auto", display: "flex", alignItems: "flex-end", width: "100%", minHeight: 0 }}>
                    <span className={c("v2-col")} style={{ flex: "none", display: "flex", flexDirection: "column", width: "100%", height: `${Math.round(((x.kcal - floorK) / (peak - floorK)) * 100)}%`, minHeight: 26, gap: 1, borderTop: `3px solid ${on ? "#a3e635" : "#84cc16"}`, transition: "transform .28s cubic-bezier(.16,1,.3,1)" }}>
                      {x.dishes.map((dish, i) => (
                        <span key={dish.slot} title={dish.slot} style={{ display: "block", minHeight: 4, flexGrow: dish.kcal, background: on ? ["#d9f99d", "#bef264", "#a3e635", "#84cc16"][i] : ["#4c4c46", "#3f3f3a", "#33332f", "#262623"][i] }} />
                      ))}
                    </span>
                  </span>
                  <b style={{ fontFamily: COND, fontWeight: 900, fontSize: "clamp(14px,1.5vw,19px)", letterSpacing: "-0.02em", fontVariantNumeric: "tabular-nums", color: on ? "#a3e635" : "#f7f7f5" }}>{Math.round(x.kcal)}</b>
                  <span className={c("v2-bar-label")} style={{ fontFamily: MONO, fontSize: 10, letterSpacing: "0.14em", textTransform: "uppercase", color: on ? "#f7f7f5" : "#85857e" }}>Day {x.d + 1}</span>
                </button>
              );
            })}
          </div>

          <div style={{ border: "1px solid #232320", background: "#070707", marginTop: "clamp(20px,2.6vw,30px)" }}>
            <div style={{ display: "flex", alignItems: "baseline", justifyContent: "space-between", gap: 16, flexWrap: "wrap", padding: "clamp(16px,2vw,22px) clamp(16px,2.2vw,26px)", borderBottom: "1px solid #232320" }}>
              <h3 style={{ fontFamily: COND, fontWeight: 900, fontSize: "clamp(1.4rem,2.6vw,2.1rem)", lineHeight: 1, letterSpacing: "-0.02em", textTransform: "uppercase", color: "#f7f7f5", margin: 0 }}>
                Day {day + 1} · {active.dishes.map((d) => d.cuisine).filter((v, i, a) => a.indexOf(v) === i).slice(0, 3).join(" · ")}
              </h3>
              <div style={{ display: "flex", gap: "clamp(14px,2.4vw,28px)", fontFamily: MONO, fontSize: 11, letterSpacing: "0.14em", textTransform: "uppercase", color: "#85857e" }}>
                <span><b style={{ color: "#84cc16", fontWeight: 700 }}>{Math.round(active.kcal).toLocaleString("en-IN")}</b> kcal</span>
                <span><b style={{ color: "#f7f7f5", fontWeight: 700 }}>{Math.round(active.protein)}g</b> protein</span>
                <span><b style={{ color: "#f7f7f5", fontWeight: 700 }}>{Math.round(active.fibre)}g</b> fibre</span>
              </div>
            </div>
            <div>
              {active.dishes.map((dish) => (
                <div key={dish.slot} className={c("v2-row", "v2-dir-row")} style={{ display: "grid", gridTemplateColumns: "104px minmax(0,1fr) minmax(0,1.35fr) auto", gap: "clamp(12px,2vw,26px)", alignItems: "baseline", background: "#070707", padding: "clamp(16px,1.8vw,22px) clamp(16px,2.2vw,26px)", borderTop: "1px solid #232320", borderLeft: "2px solid transparent" }}>
                  <span style={{ fontFamily: MONO, fontSize: 10.5, letterSpacing: "0.2em", textTransform: "uppercase", color: "#85857e" }}>{dish.slot}</span>
                  <h4 style={{ fontFamily: COND, fontWeight: 800, fontSize: "clamp(1.05rem,1.6vw,1.28rem)", lineHeight: 1.05, letterSpacing: "-0.01em", textTransform: "uppercase", color: "#f7f7f5", margin: 0 }}>{dish.name}</h4>
                  <p className={c("v2-hide-sm")} style={{ fontFamily: SANS, fontSize: 13, lineHeight: 1.55, color: "#9a9a94", margin: 0 }}>{dish.blurb}</p>
                  <div style={{ display: "flex", gap: 14, justifyContent: "flex-end", fontFamily: MONO, fontSize: 11.5, letterSpacing: "0.06em", color: "#85857e", fontVariantNumeric: "tabular-nums", whiteSpace: "nowrap" }}>
                    <span style={{ color: "#f7f7f5" }}>{dish.kcal} kcal</span><span>{Math.round(dish.protein)}g P</span><span>{Math.round(dish.carbs)}g C</span><span>{Math.round(dish.fat)}g F</span>
                  </div>
                </div>
              ))}
            </div>
      ...
      {/* ══ CLOSE ══ */}
      <section id="v2-close" aria-labelledby="v2-close-h" style={{ position: "relative", overflow: "hidden", borderTop: "1px solid #232320" }}>
        <span aria-hidden="true" style={{ position: "absolute", inset: 0, background: "linear-gradient(180deg,#070707 0%,rgba(7,7,7,0.72) 40%,#070707 100%)" }} />
        <div style={{ position: "relative", ...WRAP, padding: "clamp(70px,10vw,140px) clamp(18px,4vw,40px)" }}>
          ...
          <h2 id="v2-close-h" style={{ fontFamily: COND, fontWeight: 900, fontSize: "clamp(2.8rem,9vw,7.5rem)", lineHeight: 0.8, letterSpacing: "-0.035em", textTransform: "uppercase", color: "#f7f7f5", margin: "20px 0 0", maxWidth: "14ch" }}>
          ...
          <div className={c("v2-split")} style={{ display: "grid", gridTemplateColumns: "minmax(0,1fr) minmax(0,1fr)", gap: "clamp(24px,4vw,56px)", alignItems: "end", marginTop: "clamp(28px,4vw,48px)" }}>
            <p style={{ fontFamily: SANS, fontSize: "clamp(16px,1.6vw,18.5px)", lineHeight: 1.62, color: "#c6c6c0", margin: 0, maxWidth: "46ch" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 14, flexWrap: "wrap" }}>
              <Link href="/plans?trial=true" className={c("v2-btn")} style={{ display: "inline-flex", alignItems: "center", background: "#84cc16", color: "#070707", fontFamily: COND, fontWeight: 900, fontSize: 17, letterSpacing: "0.06em", textTransform: "uppercase", padding: "17px 30px", minHeight: 52, border: "1px solid #84cc16" }}><span>Book your trial day</span></Link>
              <a href={waHref} target="_blank" rel="noopener noreferrer" className={c("v2-ghost")} style={{ display: "inline-flex", alignItems: "center", gap: 10, color: "#f7f7f5", fontFamily: COND, fontWeight: 700, fontSize: 16, letterSpacing: "0.06em", textTransform: "uppercase", padding: "16px 26px", minHeight: 52, border: "1px solid #33332f" }}>Order on WhatsApp</a>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* ══ STICKY ORDER BAR ══ */}
      <div style={{ position: "fixed", left: 0, right: 0, bottom: 0, zIndex: 60, transform: `translateY(${showBar ? "0%" : "110%"})`, transition: "transform .34s cubic-bezier(.16,1,.3,1)", background: "#070707", borderTop: "1px solid #232320" }}>
        <div style={{ maxWidth: 1240, margin: "0 auto", padding: "11px clamp(14px,4vw,40px)", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 14 }}>
          <div className={c("v2-hide-sm")} style={{ display: "flex", alignItems: "baseline", gap: 14, minWidth: 0 }}>
            <span style={{ fontFamily: COND, fontWeight: 900, fontSize: "clamp(18px,2vw,24px)", letterSpacing: "-0.02em", textTransform: "uppercase", color: "#f7f7f5", whiteSpace: "nowrap" }}>Trial day ₹{decompose(400, 1).total}</span>
            <span style={{ fontFamily: MONO, fontSize: 11.5, letterSpacing: "0.12em", textTransform: "uppercase", color: "#85857e", whiteSpace: "nowrap" }}>cut-off in <b suppressHydrationWarning style={{ color: "#f7f7f5", fontWeight: 700, fontVariantNumeric: "tabular-nums" }}>{countdown}</b></span>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: 10, flex: "1 1 auto", justifyContent: "flex-end" }}>
            <a href={waHref} target="_blank" rel="noopener noreferrer" style={{ display: "inline-flex", alignItems: "center", gap: 9, background: "#25d366", color: "#06140b", fontFamily: COND, fontWeight: 800, fontSize: 14, letterSpacing: "0.05em", textTransform: "uppercase", padding: "12px 18px", minHeight: 48, border: "1px solid #25d366" }}>
              <svg viewBox="0 0 24 24" width="17" height="17" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                <path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z" />
              </svg>
              WhatsApp
            </a>
            <Link href="/plans?trial=true" className={c("v2-btn")} style={{ display: "inline-flex", alignItems: "center", background: "#84cc16", color: "#070707", fontFamily: COND, fontWeight: 900, fontSize: 14, letterSpacing: "0.06em", textTransform: "uppercase", padding: "12px 22px", minHeight: 48, border: "1px solid #84cc16" }}><span>Order now</span></Link>
          </div>
        </div>
      </div>
    </div>

...
/* ════════ FEATURE MOCKUPS ════════ */
function ScaleMock() {
  return (<div style={panel()}>{bar(LIME)}{chrome("Body metrics", LIME, <span style={{ display: "inline-flex", alignItems: "center", gap: 6, fontSize: 10, fontWeight: 700, color: LIME, letterSpacing: "0.08em" }}><Scale size={12} /> SCALE SYNC — COMING SOON</span>)}
...
const features: Feature[] = [
  { eyebrow: "Weigh in", accent: LIME, title: <>Track your body,<br />not just your weight.</>, desc: "Log weekly weigh-ins with body fat, muscle and BMI and watch the full picture trend over time. Bluetooth smart-scale sync (FitDays) is coming soon — until then, logging takes ten seconds.", bullets: ["Body fat, muscle, BMI, water and visceral fat", "Smart-scale Bluetooth sync coming soon"], mock: <ScaleMock /> },
...
const universe: { cat: string; count: string; sub: string; icon: React.ReactNode; href: string; plans: Chip[] }[] = [
  ...
  { cat: "Medical & Clinical", count: "37 plans", sub: "Condition-specific nutrition", icon: <HeartPulse size={16} color="#2dd4bf" />, href: "/plans?category=LIFESTYLE_MEDICAL", plans: [{ n: "PCOS", c: "#f472b6" }, { n: "Diabetic", c: "#2dd4bf" }, { n: "Thyroid", c: "#a78bfa" }, { n: "Heart Health", c: "#fb7185" }, { n: "Hypertension", c: "#fb7185" }, { n: "Fatty Liver", c: "#34d399" }, { n: "Kidney Health", c: "#38bdf8" }, { n: "Gout", c: "#fb923c" }, { n: "Anaemia", c: "#fb7185" }, { n: "Obesity", c: "#fb923c" }, { n: "Gut Health", c: "#34d399" }, { n: "Knee & Joints", c: "#38bdf8" }] },
  { cat: "Women's Health", count: "12 plans", sub: "Hormones, cycle, motherhood", icon: <Sparkles size={16} color="#f9a8d4" />, href: "/plans?category=LIFESTYLE_MEDICAL", plans: [{ n: "PCOS", c: "#f9a8d4" }, { n: "Menopause", c: "#f9a8d4" }, { n: "Fertility", c: "#f9a8d4" }, { n: "Post-Pregnancy", c: "#f9a8d4" }, { n: "PMS", c: "#f9a8d4" }, { n: "Hormonal Acne", c: "#f9a8d4" }] },
  { cat: "Skin & Hair", count: "10 plans", sub: "Nutrition for how you look", icon: <Leaf size={16} color="#fbbf24" />, href: "/plans?category=LIFESTYLE_MEDICAL", plans: [{ n: "Anti-Aging", c: "#fbbf24" }, { n: "Acne", c: "#fbbf24" }, { n: "Hair Health", c: "#fbbf24" }, { n: "Eczema", c: "#fbbf24" }, { n: "Skin Glow", c: "#fbbf24" }] },
  { cat: "Recovery & Reset", count: "11 plans", sub: "Heal, quit, rebuild", icon: <RefreshCw size={16} color="#4ade80" />, href: "/plans?category=LIFESTYLE_MEDICAL", plans: [{ n: "Quit Smoking", c: "#4ade80" }, { n: "Alcohol Recovery", c: "#94a3b8" }, { n: "Post-Surgery", c: "#34d399" }, { n: "Post-Covid", c: "#34d399" }, { n: "Cancer Recovery", c: "#34d399" }, { n: "Detox Reset", c: "#34d399" }] },
  { cat: "Seasonal & Festival", count: "4 plans", sub: "Eat right through the calendar", icon: <Clock size={16} color="#f97316" />, href: "/plans?category=LIFESTYLE_MEDICAL", plans: [{ n: "Navratri", c: "#f97316" }, { n: "Ramadan", c: "#f97316" }, { n: "Diwali Detox", c: "#f97316" }, { n: "Shravan", c: "#f97316" }] },
  { cat: "Sports Nutrition", count: "20 plans", sub: "Fuel for your sport", icon: <Dumbbell size={16} color="#c084fc" />, href: "/plans?category=SPORTS", plans: [{ n: "Strength & Hypertrophy", c: "#c084fc" }, { n: "Endurance", c: "#c084fc" }, { n: "Cricket", c: "#c084fc" }, { n: "Football", c: "#c084fc" }, { n: "Swimming", c: "#c084fc" }, { n: "Martial Arts", c: "#c084fc" }, { n: "Competition Prep", c: "#c084fc" }, { n: "Youth Athlete", c: "#c084fc" }] },
];
...
function resolvePlan(goal: string, diet: string, cond: string): { name: string; accent: string; href: string; note: string } {
  ...
  if (goal === "Manage a condition") {
    ...
    return { name: `${m.name}, ${diet}`, accent: m.accent, href: `/plans/${m.slug}-${useDiet}`, note: "Condition-specific, low-GI, anti-inflammatory" };
  }
  ...
  if (goal === "Improve performance") return { name: `Strength & Hypertrophy, ${diet}`, accent: "#c084fc", href: `/plans/strength-hypertrophy-${dietSlug === "non-veg" ? "non-veg" : "veg"}`, note: "2.2g per kg protein, carb cycling" };
...
const tiers = [
  ...
  { name: "Premium", accent: AMBER, price: "From ₹30,000", unit: "per month, B+L", line: "Meals, your stack, a plan.", status: "Waitlist open", featured: true, cta: { label: "Join waitlist", href: "/plans" }, feats: ["Everything in Standard", "Upgraded ingredients and weekly chef special", "Linked workout schedule", "Personalised supplement stack and delivery", "Weekly progress PDF and priority support"] },
  { name: "Luxury", accent: FUCHSIA, price: "From ₹45,000", unit: "per month, B+L", line: "Your full-time AI trainer.", status: "Waitlist open", cta: { label: "Join waitlist", href: "/plans" }, feats: ["Everything in Premium", "AI personal trainer chat", "One-on-one nutritionist consult", "Custom meal-plan adjustments", "Concierge delivery and quarterly report"] },
];
const trustBadges = [
      ...
      <section style={{ padding: "96px 0", borderTop: "1px solid #121212" }}>
        <div style={{ ...WRAP }} className="ff-pad">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-80px" }} variants={stagger}>
            ...
            <motion.p variants={fadeUp} style={{ textAlign: "center", fontSize: 13, color: "#52525b", marginTop: 22 }}>Prices shown for Breakfast plus Lunch. Full pricing, durations and the complete tier matrix on the <Link href="/plans" style={{ color: LIME, textDecoration: "none" }}>plans page</Link>.</motion.p>
          </motion.div>
        </div>
      </section>

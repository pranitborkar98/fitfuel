  ...
  return (
    <FadeItem>
      ...
      >
        ...
        <div style={{ fontSize: 13, color: "#9ca3af", fontWeight: 500, letterSpacing: "0.05em" }}>
          {label}
        </div>
      </div>
    </FadeItem>
      ...
      <section style={{ paddingTop: 140, paddingBottom: 100 }}>
        <div style={WRAP}>
          <motion.div initial="hidden" animate="visible" variants={stagger}>
            ...
            <FadeItem>
              <p style={{
                fontSize: 18, color: "#9ca3af", lineHeight: 1.8,
              ...
              <FadeItem>
                <div style={{ marginTop: 28, display: "flex", alignItems: "center", gap: 12 }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: 12, color: "#6b7280" }}>Founder, FitFuel</div>
                  </div>
                </div>
              </FadeItem>
            </div>
            ...
            <FadeSection>
              <FadeItem>
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.15em", color: "#84cc16", textTransform: "uppercase", marginBottom: 6 }}>
                    Founder & CEO
                  </div>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                    {[
                      ...
                      <div key={item.label} style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 16 }}>
                        <span style={{ fontSize: 12, color: "#6b7280", fontWeight: 500, minWidth: 120 }}>{item.label}</span>
                  ...
                  <FadeItem>
                    <div style={{ display: "flex", gap: 40, paddingBottom: i < TIMELINE.length - 1 ? 48 : 0 }}>
                      ...
                      <div style={{ paddingTop: 12, flex: 1 }}>
                        ...
                        <p style={{ fontSize: 14, color: "#9ca3af", lineHeight: 1.75, maxWidth: 560 }}>
                          {item.desc}
                        </p>
                      </div>
                    </div>
            ...
            <FadeItem>
              <div style={{
                ...
                <div style={{ position: "relative", zIndex: 1 }}>
                  <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.2em", color: "#84cc16", textTransform: "uppercase", marginBottom: 14 }}>
                    — Start today
                  </div>
                  <h2 style={{
                    fontFamily: "'Barlow Condensed', sans-serif",
                  ...
                  <p style={{ fontSize: 15, color: "#9ca3af", maxWidth: 420, lineHeight: 1.7 }}>
